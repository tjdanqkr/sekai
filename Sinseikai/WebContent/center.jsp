		...
		<div class="search_faq-form">
			<form id="faqSearchForm" action="/cca-fo/faq/search" method="get">
				<fieldset>
					...
					<label for="search_faq" class="a11y_sr-only"></label>
				...
				<ul class="rank">
					<li ::before><a  href="/cca-fo/faq/viewFAQ/P00001/P00009">배송확인</a></li>
					
					<li ::before>
					
					<a  href="/cca-fo/faq/viewFAQ/P00003/P00023">주문내역확인</a></li>
					<li ::before>
					 
					<a  href="/cca-fo/faq/viewFAQ/P00006/P00049">L.POINT</a></li>
					<li ::before>
					
					<a  href="/cca-fo/faq/viewFAQ/P00002/P00017">반품접수</a></li>
					<li ::before>
					
					<a  href="/cca-fo/faq/viewFAQ/P00002/P00016">교환접수</a></li ::after>
					
				</ul>
			
		</div>
		<script type="text/javascript" src="/cca-fo/cca/js/faq/searchBar.js"></script>
